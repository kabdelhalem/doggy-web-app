...
const JoinFamily = () => {
  ...
  const handleCreateFamilyClick = () => {
    navigate("/getstarted/create"); // Navigate to the specified route
  };
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <form>
        ...
        <div class="grid md:grid-cols-2 md:gap-6">
          <div class="relative z-0 w-full mb-6 group">
            <div className="text-sm text-gray-900">Click to join a family</div>
            <button
          ...
          <div class="relative z-0 w-full mb-6 group">
            <div className="text-sm text-gray-900">Dont have a family?</div>
            <button
              formNoValidate
              type="button"
